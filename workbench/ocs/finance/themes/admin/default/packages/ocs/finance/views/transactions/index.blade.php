...
@section('title')
@parent
{{ trans('ocs/finance::transactions/common.title') }}
@stop
...
{{ Asset::queue('index', 'ocs/finance::transactions/js/index.js', 'platform') }}
...
<section class="panel panel-default panel-grid">
		...
		<nav class="navbar navbar-default navbar-actions">
			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<span class="navbar-brand">{{{ trans('ocs/finance::transactions/common.title') }}}</span>
				...
				<div class="collapse navbar-collapse" id="actions">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="primary">
							<a href="{{ route('admin.ocs.finance.transactions.create') }}" data-toggle="tooltip" data-original-title="{{{ trans('action.create') }}}">
					...
					{{-- Grid: Filters --}}
					<form class="navbar-form navbar-right" method="post" accept-charset="utf-8" data-search data-grid="transaction" role="form">
						...
						<div class="input-group">
							...
							<span class="input-group-btn">
								...
								<ul class="dropdown-menu" role="menu">
									...
									<li>
										<a data-grid="transaction" data-filter="enabled:1" data-label="enabled::{{{ trans('common.all_enabled') }}}" data-reset>
											<i class="fa fa-eye"></i> {{{ trans('common.show_enabled') }}}
										</a>
									</li>

									<li>
										<a data-toggle="tooltip" data-placement="top" data-original-title="" data-grid="transaction" data-filter="enabled:0" data-label="enabled::{{{ trans('common.all_disabled') }}}" data-reset>
							...
							<span class="input-group-btn">
								...
								<button class="btn btn-default" data-grid="transaction" data-reset>
	...
	<div class="panel-body">
		...
		<div class="btn-toolbar" role="toolbar" aria-label="data-grid-applied-filters">
			...
			<div id="data-grid_applied" class="btn-group" data-grid="transaction"></div>
	...
	<div class="table-responsive">
		...
		<table id="data-grid" class="table table-hover" data-source="{{ route('admin.ocs.finance.transactions.grid') }}" data-grid="transaction">
			<thead>
				<tr>
					<th><input data-grid-checkbox="all" type="checkbox"></th>
					<th class="sortable" data-sort="Company">{{{ trans('ocs/finance::transactions/model.general.Company') }}}</th>
					<th class="sortable" data-sort="Calendar">{{{ trans('ocs/finance::transactions/model.general.Calendar') }}}</th>
					<th class="sortable" data-sort="Amount">{{{ trans('ocs/finance::transactions/model.general.Amount') }}}</th>
					<th class="sortable" data-sort="Type">{{{ trans('ocs/finance::transactions/model.general.Type') }}}</th>
					<th class="sortable" data-sort="Paid_By">{{{ trans('ocs/finance::transactions/model.general.Paid_By') }}}</th>
					<th class="sortable" data-sort="created_at">{{{ trans('ocs/finance::transactions/model.general.created_at') }}}</th>
				</tr>
			</thead>
			<tbody></tbody>
		</table>
	...
	<footer class="panel-footer clearfix">
		...
		{{-- Grid: Pagination --}}
		<div id="data-grid_pagination" data-grid="transaction"></div>

	</footer>

	{{-- Grid: templates --}}
	@include('ocs/finance::transactions/grid/index/results')
	@include('ocs/finance::transactions/grid/index/pagination')
	@include('ocs/finance::transactions/grid/index/filters')
	@include('ocs/finance::transactions/grid/index/no_results')

</section>

@if (config('platform.app.help'))
	@include('ocs/finance::transactions/help')
@endif
