...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'transaction');

		$('.daterangepicker_end_input').attr('data-grid', 'transaction');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('transaction', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
	};
