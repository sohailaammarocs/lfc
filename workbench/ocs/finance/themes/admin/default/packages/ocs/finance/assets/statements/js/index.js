...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'statement');

		$('.daterangepicker_end_input').attr('data-grid', 'statement');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('statement', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
	};
