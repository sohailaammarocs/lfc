...
@section('title')
@parent
{{ trans('ocs/finance::statements/common.title') }}
@stop
...
{{ Asset::queue('index', 'ocs/finance::statements/js/index.js', 'platform') }}
...
<section class="panel panel-default panel-grid">
		...
		<nav class="navbar navbar-default navbar-actions">
			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<span class="navbar-brand">{{{ trans('ocs/finance::statements/common.title') }}}</span>
				...
				<div class="collapse navbar-collapse" id="actions">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="primary">
							<a href="{{ route('admin.ocs.finance.statements.create') }}" data-toggle="tooltip" data-original-title="{{{ trans('action.create') }}}">
					...
					{{-- Grid: Filters --}}
					<form class="navbar-form navbar-right" method="post" accept-charset="utf-8" data-search data-grid="statement" role="form">
						...
						<div class="input-group">
							...
							<span class="input-group-btn">
								...
								<ul class="dropdown-menu" role="menu">
									...
									<li>
										<a data-grid="statement" data-filter="enabled:1" data-label="enabled::{{{ trans('common.all_enabled') }}}" data-reset>
											<i class="fa fa-eye"></i> {{{ trans('common.show_enabled') }}}
										</a>
									</li>

									<li>
										<a data-toggle="tooltip" data-placement="top" data-original-title="" data-grid="statement" data-filter="enabled:0" data-label="enabled::{{{ trans('common.all_disabled') }}}" data-reset>
							...
							<span class="input-group-btn">
								...
								<button class="btn btn-default" data-grid="statement" data-reset>
	...
	<div class="panel-body">
		...
		<div class="btn-toolbar" role="toolbar" aria-label="data-grid-applied-filters">
			...
			<div id="data-grid_applied" class="btn-group" data-grid="statement"></div>
	...
	<div class="table-responsive">
		...
		<table id="data-grid" class="table table-hover" data-source="{{ route('admin.ocs.finance.statements.grid') }}" data-grid="statement">
			<thead>
				<tr>
					<th><input data-grid-checkbox="all" type="checkbox"></th>
					<th class="sortable" data-sort="Date">{{{ trans('ocs/finance::statements/model.general.Date') }}}</th>
					<th class="sortable" data-sort="Description">{{{ trans('ocs/finance::statements/model.general.Description') }}}</th>
					<th class="sortable" data-sort="Money_in">{{{ trans('ocs/finance::statements/model.general.Money_in') }}}</th>
					<th class="sortable" data-sort="Money_out">{{{ trans('ocs/finance::statements/model.general.Money_out') }}}</th>
					<th class="sortable" data-sort="Balance">{{{ trans('ocs/finance::statements/model.general.Balance') }}}</th>
					<th class="sortable" data-sort="created_at">{{{ trans('ocs/finance::statements/model.general.created_at') }}}</th>
				</tr>
			</thead>
			<tbody></tbody>
		</table>
	...
	<footer class="panel-footer clearfix">
		...
		{{-- Grid: Pagination --}}
		<div id="data-grid_pagination" data-grid="statement"></div>

	</footer>

	{{-- Grid: templates --}}
	@include('ocs/finance::statements/grid/index/results')
	@include('ocs/finance::statements/grid/index/pagination')
	@include('ocs/finance::statements/grid/index/filters')
	@include('ocs/finance::statements/grid/index/no_results')

</section>

@if (config('platform.app.help'))
	@include('ocs/finance::statements/help')
@endif
