...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'products');

		$('.daterangepicker_end_input').attr('data-grid', 'products');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('products', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
	};
