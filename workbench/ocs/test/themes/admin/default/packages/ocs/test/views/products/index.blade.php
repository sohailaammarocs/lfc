...
@section('title')
@parent
{{ trans('ocs/test::products/common.title') }}
@stop
...
{{ Asset::queue('index', 'ocs/test::products/js/index.js', 'platform') }}
...
<section class="panel panel-default panel-grid">
		...
		<nav class="navbar navbar-default navbar-actions">
			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<span class="navbar-brand">{{{ trans('ocs/test::products/common.title') }}}</span>
				...
				<div class="collapse navbar-collapse" id="actions">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="primary">
							<a href="{{ route('admin.ocs.test.products.create') }}" data-toggle="tooltip" data-original-title="{{{ trans('action.create') }}}">
					...
					{{-- Grid: Filters --}}
					<form class="navbar-form navbar-right" method="post" accept-charset="utf-8" data-search data-grid="products" role="form">
						...
						<div class="input-group">
							...
							<span class="input-group-btn">
								...
								<ul class="dropdown-menu" role="menu">
									...
									<li>
										<a data-grid="products" data-filter="enabled:1" data-label="enabled::{{{ trans('common.all_enabled') }}}" data-reset>
											<i class="fa fa-eye"></i> {{{ trans('common.show_enabled') }}}
										</a>
									</li>

									<li>
										<a data-toggle="tooltip" data-placement="top" data-original-title="" data-grid="products" data-filter="enabled:0" data-label="enabled::{{{ trans('common.all_disabled') }}}" data-reset>
							...
							<span class="input-group-btn">
								...
								<button class="btn btn-default" data-grid="products" data-reset>
	...
	<div class="panel-body">
		...
		<div class="btn-toolbar" role="toolbar" aria-label="data-grid-applied-filters">
			...
			<div id="data-grid_applied" class="btn-group" data-grid="products"></div>
	...
	<div class="table-responsive">
		...
		<table id="data-grid" class="table table-hover" data-source="{{ route('admin.ocs.test.products.grid') }}" data-grid="products">
			<thead>
				<tr>
					<th><input data-grid-checkbox="all" type="checkbox"></th>
					<th class="sortable" data-sort="id">{{{ trans('ocs/test::products/model.general.id') }}}</th>
					<th class="sortable" data-sort="name">{{{ trans('ocs/test::products/model.general.name') }}}</th>
					<th class="sortable" data-sort="image">{{{ trans('ocs/test::products/model.general.image') }}}</th>
					<th class="sortable" data-sort="price">{{{ trans('ocs/test::products/model.general.price') }}}</th>
					<th class="sortable" data-sort="desc">{{{ trans('ocs/test::products/model.general.desc') }}}</th>
					<th class="sortable" data-sort="created_at">{{{ trans('ocs/test::products/model.general.created_at') }}}</th>
				</tr>
			</thead>
			<tbody></tbody>
		</table>
	...
	<footer class="panel-footer clearfix">
		...
		{{-- Grid: Pagination --}}
		<div id="data-grid_pagination" data-grid="products"></div>

	</footer>

	{{-- Grid: templates --}}
	@include('ocs/test::products/grid/index/results')
	@include('ocs/test::products/grid/index/pagination')
	@include('ocs/test::products/grid/index/filters')
	@include('ocs/test::products/grid/index/no_results')

</section>

@if (config('platform.app.help'))
	@include('ocs/test::products/help')
@endif
