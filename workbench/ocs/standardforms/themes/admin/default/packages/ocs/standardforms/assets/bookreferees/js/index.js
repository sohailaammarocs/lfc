...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'bookreferees');

		$('.daterangepicker_end_input').attr('data-grid', 'bookreferees');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('bookreferees', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
	};
