...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'joincompetition');

		$('.daterangepicker_end_input').attr('data-grid', 'joincompetition');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('joincompetition', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
	};
