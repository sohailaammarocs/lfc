...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'contactusform');

		$('.daterangepicker_end_input').attr('data-grid', 'contactusform');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('contactusform', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
	};
